...
- [A mathematical description of a neuron](https://medium.com/coinmonks/the-mathematics-of-neural-network-60a112dd3e05)
- [Basic ROP and debugging with GDB](https://trustfoundry.net/2019/07/18/basic-rop-techniques-and-tricks/)
- [Reverse engineering of compiled Rust](https://research.checkpoint.com/2023/rust-binary-analysis-feature-by-feature/)
